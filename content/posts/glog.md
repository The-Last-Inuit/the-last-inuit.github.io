...
* is fun rather than… professional 😅

```bash
glog/
  glog-cli/     # Lua, löve2D engine
  glog-server/  # Elixir
```
...
<object data="/lua-cs.pdf" type="application/pdf" style="width:100%; height:100vh;">
  <p>
    Your browser can’t display PDFs inline.
    <a href="/lua-cs.pdf">Open the PDF</a>
  </p>
</object>
