...
If you’re curious, the `saal-core` crate is the best place to look right now. It’s intentionally tight and focused, so it should be easy to follow and extend.
